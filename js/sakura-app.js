...
function imgError (ele, type) {
  switch (type) {
    ...
    case 3:
      ...
      ele.src = 'https://cdn.jsdelivr.net/gh/HTC-Group/cdn@2.2/img/other/alone.png'
      break
    default:
      ele.src = 'https://cdn.jsdelivr.net/gh/HTC-Group/cdn@2.2/img/other/alone.png'
  }
...
function checkBgImgCookie() {
  ...
  if (bgurl != '') {
    ...
    } else if (bgurl == 'https://img.paulzzh.tech/touhou/random') {
      mashiro_global.variables.skinSecter = true
     ...
     /* if (!valine) {
       var valine = new Valine()
        valine.init({
          ...
          placeholder: "昵称输入QQ号会自动填充QQ昵称、头像和邮箱~\\(≧▽≦)/~",
          highlight: false,
